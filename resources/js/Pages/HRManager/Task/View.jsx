...
export default function View({auth,data, Id, developer,bugs,result,taskHistory }) {
     ...
     return (
       <>
                {data.length === 0 ? (
                            ...
                            <div className="max-w-7xl mx-auto sm:px-2 lg:px-4">
                                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                    ...
                                    <Box display={'flex'} justifyContent={'center'} alignItems={'center'} flexDirection={'column'} height={'50vh'}>
                                        ...
                                        <Typography sx={{color:"#000000",paddingBottom:"5px"}}>No task Found yet!</Typography>
                  ...
                  <List auth={auth} data={data} Id={Id} developer={developer} bugs={bugs} result={result} history={taskHistory}/>
                )}
                </>
    );
}
